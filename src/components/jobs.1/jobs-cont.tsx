        ...
        return <div className="section jobs-cont">
            ...
            <div className="section-main-description section-with-floating-image">
                <div className="side-images">
                    ...
                    <img src="build/assets/icons/react-redux.png" className="image-near-text image-near-text-rr filled" />
                </div>
                <p>
                ...
                After the GGE we created our fanpage: <a href="https://www.facebook.com/CursedValley/">Cursed Valley</a> and
                    ...
                    <div className="center">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/o0Wxu2FK06A" allowFullScreen></iframe>
                    </div>
                    <br />
                    <br />
