...
const images = ['/assets/games/game-civic.jpg',
    '/assets/games/game-izo.jpg',
    '/assets/games/game-literaki.jpg',
    '/assets/games/game-ogl.jpg',
    '/assets/games/game-oneproj.jpg',
    '/assets/games/game-sudo.jpg',];
