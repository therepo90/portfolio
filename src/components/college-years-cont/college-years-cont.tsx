        ...
        return <div className="section college-cont">
            ...
            <div className="section-main-description section-with-floating-image">
                <div className="side-images">
                    ...
                    <img src="build/assets/icons/java2.png" className="image-near-text image-near-text-java filled" />
                    <img src="build/assets/icons/csharp.png" className="image-near-text image-near-text-csharp filled" />
                </div>
                <p>
